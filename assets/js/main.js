(function ($) {
    ...
    function PortfolioSlider() {
        ...
        $('.right-over-next').on("click", function () {
            PortfolioSlide.trigger('next.owl.carousel');
        })
        $('.right-over-prev').on("click", function () {
            PortfolioSlide.trigger('prev.owl.carousel');
        })
    }
    ...
    var PortfolioSlide = new Swiper('.swiper-container', {
    ...
    PortfolioSlide.on('slideChange', function () {
    ...
    PortfolioSlide.on('slideChangeTransitionEnd', function () {
        TweenMax.to('.text-1', 0.3, {
            y: '0',
